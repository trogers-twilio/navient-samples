...
class InQueueVoicemailComponent extends React.Component {
  ...
  // Leaving this code here in case the functionality is desired in the future
  // startTransfer() {
  //   // POST to transfer task:
  //   async function transferTask(url = '', data = {}) {
  //     // Default options are marked with *
  ...
  startCall() {
    ...
    let attr = {
      ...
      tempReservationSid: this.props.task.sid
    };
  ...
  render() {
    ...
    layout = (
      <span class='Twilio'>
        ...
        {/* Leaving this code in case the functionality is desired in the future
